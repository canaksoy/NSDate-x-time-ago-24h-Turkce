...
- (NSString *)formatMinutesAgo:(NSTimeInterval)secondsSince
{
    ...
    if(minutesSince == 1)
        ...
        return [NSString stringWithFormat:@"%d dakika önce", minutesSince];
}
...
- (NSString *)formatAsToday:(NSTimeInterval)secondsSince
{
    ...
    if(hoursSince == 1)
        ...
        return [NSString stringWithFormat:@"%d saat önce", hoursSince];
}
...
- (NSString *)formatAsYesterday
{
    ...
    return [NSString stringWithFormat:@"Dün %@", [dateFormatter stringFromDate:self]];
}
...
- (NSString *)formatAsOther
{
    ...
    //Format
    [dateFormatter setDateFormat:@"d LLLL yyyy HH:mm"];
    return [dateFormatter stringFromDate:self];
}
